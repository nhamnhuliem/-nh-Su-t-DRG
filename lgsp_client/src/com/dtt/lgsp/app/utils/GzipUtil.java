	...
	public static void main(String[] args) throws Exception {
       ...
       // System.out.println("after decompress:");
        ...
        for (String pathname : pathnames) {
           ...
           String content =  FileUtils.readFileToString(new File(folderPath+"\\"+pathname));
            String decomp = decompress(content);
            // System.out.println(decomp);
            try {
				BufferedWriter writer = new BufferedWriter(new FileWriter("E:\\luat.pham\\DRG\\soft\\filemaudongbo\\KETQUA_GUIHOSO\\20201214\\unzip_"+System.currentTimeMillis() +".xml"));
			    writer.write(decomp);
			    writer.close();
				}catch (Exception e) {
					// TODO: handle exception
				}
            System.out.println("Length:"+decomp.length());
        }
