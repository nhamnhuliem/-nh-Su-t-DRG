...
public class TongHop {
	...
	public TongHop(String ma_lk, int stt, String ma_bn, String ho_ten, String ngay_sinh, int gioi_tinh, String dia_chi,
			...
			String ngay_vao, String ngay_ra, double so_ngay_dtri, int ket_qua_dtri, int tinh_trang_rv,
			String ngay_ttoan, double t_thuoc, double t_vtyt, double t_tongchi, double t_bntt, double t_bncct,
			double t_bhtt, double t_nguonkhac, double t_ngoaids, int nam_qt, int thang_qt, int ma_loai_kcb,
			String ma_khoa, String ma_cskcb, String ma_khuvuc, String ma_pttt_qt, double can_nang, Date ngay_tao,
			int trangthai) {
		super();
		this.ma_lk = ma_lk;
		this.stt = stt;
