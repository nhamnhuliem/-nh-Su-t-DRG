...
<head>
	...
	<link href="${theme_display.getPathThemeCss()}/uikit.min.css" rel="stylesheet">
	<link href="${theme_display.getPathThemeCss()}/bootstrap-4.3.1.css" rel="stylesheet">
	<link href="${theme_display.getPathThemeCss()}/style.css" rel="stylesheet">
	<link href="${theme_display.getPathThemeCss()}/font.css" rel="stylesheet">
	<link href="${theme_display.getPathThemeCss()}/all.css" rel="stylesheet">
...
<div class="" id="wrapper">	
	<header class="bg-xanh d-none d-lg-block" id="banner" role="banner">
