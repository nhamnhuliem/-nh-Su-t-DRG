...
/**
 * Provides the local service utility for DashboardDinhSuat. This utility wraps
 * <code>drg.moh.service.service.impl.DashboardDinhSuatLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DashboardDinhSuatLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>drg.moh.service.service.impl.DashboardDinhSuatLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DashboardDinhSuat addDashboardDinhSuat(
		DashboardDinhSuat dashboardDinhSuat) {

		return getService().addDashboardDinhSuat(dashboardDinhSuat);
	}
	 ...
	 */
	public static DashboardDinhSuat createDashboardDinhSuat(long id) {
		return getService().createDashboardDinhSuat(id);
	}
	 ...
	 */
	public static DashboardDinhSuat deleteDashboardDinhSuat(
		DashboardDinhSuat dashboardDinhSuat) {

		return getService().deleteDashboardDinhSuat(dashboardDinhSuat);
	}
	 ...
	 */
	public static DashboardDinhSuat deleteDashboardDinhSuat(long id)
		throws PortalException {

		return getService().deleteDashboardDinhSuat(id);
	}
	...
	public static List<DashboardDinhSuat> fetchByORG_MUC_NAM(
	...
	public static DashboardDinhSuat fetchDashboardDinhSuat(long id) {
		return getService().fetchDashboardDinhSuat(id);
	}
	 ...
	 * @throws PortalException if a dashboard dinh suat with the primary key could not be found
	 */
	public static DashboardDinhSuat getDashboardDinhSuat(long id)
		throws PortalException {

		return getService().getDashboardDinhSuat(id);
	}
	 ...
	 */
	public static List<DashboardDinhSuat> getDashboardDinhSuats(
		int start, int end) {

		return getService().getDashboardDinhSuats(start, end);
	}
	 ...
	 */
	public static int getDashboardDinhSuatsCount() {
		return getService().getDashboardDinhSuatsCount();
	}
	 ...
	 */
	public static DashboardDinhSuat updateDashboardDinhSuat(
		DashboardDinhSuat dashboardDinhSuat) {

		return getService().updateDashboardDinhSuat(dashboardDinhSuat);
	}

	public static DashboardDinhSuatLocalService getService() {
		return _service;
	}

	private static volatile DashboardDinhSuatLocalService _service;
