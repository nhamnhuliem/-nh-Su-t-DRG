...
/**
 * Provides the local service utility for DashboardChiPhiHoatDong. This utility wraps
 * <code>drg.moh.service.service.impl.DashboardChiPhiHoatDongLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DashboardChiPhiHoatDongLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>drg.moh.service.service.impl.DashboardChiPhiHoatDongLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DashboardChiPhiHoatDong addDashboardChiPhiHoatDong(
		DashboardChiPhiHoatDong dashboardChiPhiHoatDong) {

		return getService().addDashboardChiPhiHoatDong(dashboardChiPhiHoatDong);
	}

	public static int countBaoCaosByOrg_Muc_Nam(long orgId, int muc, int nam) {
		return getService().countBaoCaosByOrg_Muc_Nam(orgId, muc, nam);
	}
	 ...
	 */
	public static DashboardChiPhiHoatDong createDashboardChiPhiHoatDong(
		long id) {

		return getService().createDashboardChiPhiHoatDong(id);
	}
	 ...
	 */
	public static DashboardChiPhiHoatDong deleteDashboardChiPhiHoatDong(
		DashboardChiPhiHoatDong dashboardChiPhiHoatDong) {

		return getService().deleteDashboardChiPhiHoatDong(
	 ...
	 */
	public static DashboardChiPhiHoatDong deleteDashboardChiPhiHoatDong(long id)
		throws PortalException {

		return getService().deleteDashboardChiPhiHoatDong(id);
	}
	...
	public static DashboardChiPhiHoatDong fetchDashboardChiPhiHoatDong(
		long id) {

		return getService().fetchDashboardChiPhiHoatDong(id);
	}
	...
	public static List<DashboardChiPhiHoatDong> getBaoCaosByOrg_Muc_Nam(
		long orgId, int muc, int nam, int start, int end) {

		return getService().getBaoCaosByOrg_Muc_Nam(
	 ...
	 * @throws PortalException if a dashboard chi phi hoat dong with the primary key could not be found
	 */
	public static DashboardChiPhiHoatDong getDashboardChiPhiHoatDong(long id)
		throws PortalException {

		return getService().getDashboardChiPhiHoatDong(id);
	}
	 ...
	 */
	public static List<DashboardChiPhiHoatDong> getDashboardChiPhiHoatDongs(
		int start, int end) {

		return getService().getDashboardChiPhiHoatDongs(start, end);
	}
	 ...
	 */
	public static int getDashboardChiPhiHoatDongsCount() {
		return getService().getDashboardChiPhiHoatDongsCount();
	}
	 ...
	 */
	public static DashboardChiPhiHoatDong updateDashboardChiPhiHoatDong(
		DashboardChiPhiHoatDong dashboardChiPhiHoatDong) {

		return getService().updateDashboardChiPhiHoatDong(
			dashboardChiPhiHoatDong);
	}

	public static DashboardChiPhiHoatDongLocalService getService() {
		return _service;
	}

	private static volatile DashboardChiPhiHoatDongLocalService _service;
