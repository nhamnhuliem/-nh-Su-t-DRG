...
/**
 * Provides the local service utility for DashboardChiPhiBinhQuan. This utility wraps
 * <code>drg.moh.service.service.impl.DashboardChiPhiBinhQuanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DashboardChiPhiBinhQuanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>drg.moh.service.service.impl.DashboardChiPhiBinhQuanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DashboardChiPhiBinhQuan addDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {

		return getService().addDashboardChiPhiBinhQuan(dashboardChiPhiBinhQuan);
	}
	 ...
	 */
	public static DashboardChiPhiBinhQuan createDashboardChiPhiBinhQuan(
		long id) {

		return getService().createDashboardChiPhiBinhQuan(id);
	}
	 ...
	 */
	public static DashboardChiPhiBinhQuan deleteDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {

		return getService().deleteDashboardChiPhiBinhQuan(
	 ...
	 */
	public static DashboardChiPhiBinhQuan deleteDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return getService().deleteDashboardChiPhiBinhQuan(id);
	}
	...
	public static DashboardChiPhiBinhQuan fetchByORG_MUC_NAM(
		...
		return getService().fetchByORG_MUC_NAM(orgId, mucBaoCao, nam);
	}

	public static DashboardChiPhiBinhQuan fetchDashboardChiPhiBinhQuan(
		long id) {

		return getService().fetchDashboardChiPhiBinhQuan(id);
	}
	 ...
	 * @throws PortalException if a dashboard chi phi binh quan with the primary key could not be found
	 */
	public static DashboardChiPhiBinhQuan getDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return getService().getDashboardChiPhiBinhQuan(id);
	}
	 ...
	 */
	public static List<DashboardChiPhiBinhQuan> getDashboardChiPhiBinhQuans(
		int start, int end) {

		return getService().getDashboardChiPhiBinhQuans(start, end);
	}
	 ...
	 */
	public static int getDashboardChiPhiBinhQuansCount() {
		return getService().getDashboardChiPhiBinhQuansCount();
	}
	 ...
	 */
	public static DashboardChiPhiBinhQuan updateDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {

		return getService().updateDashboardChiPhiBinhQuan(
			dashboardChiPhiBinhQuan);
	}

	public static DashboardChiPhiBinhQuanLocalService getService() {
		return _service;
	}

	private static volatile DashboardChiPhiBinhQuanLocalService _service;
