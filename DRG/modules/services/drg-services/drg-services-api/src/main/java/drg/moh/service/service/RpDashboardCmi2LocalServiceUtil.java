...
/**
 * Provides the local service utility for RpDashboardCmi2. This utility wraps
 * <code>drg.moh.service.service.impl.RpDashboardCmi2LocalServiceImpl</code> and
 ...
 * @generated
 */
public class RpDashboardCmi2LocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>drg.moh.service.service.impl.RpDashboardCmi2LocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RpDashboardCmi2 addRpDashboardCmi2(
		RpDashboardCmi2 rpDashboardCmi2) {

		return getService().addRpDashboardCmi2(rpDashboardCmi2);
	}
	 ...
	 */
	public static RpDashboardCmi2 createRpDashboardCmi2(long id) {
		return getService().createRpDashboardCmi2(id);
	}
	 ...
	 */
	public static RpDashboardCmi2 deleteRpDashboardCmi2(long id)
		throws PortalException {

		return getService().deleteRpDashboardCmi2(id);
	}
	 ...
	 * @return the rp dashboard cmi2 that was removed
	 */
	public static RpDashboardCmi2 deleteRpDashboardCmi2(
		RpDashboardCmi2 rpDashboardCmi2) {

		return getService().deleteRpDashboardCmi2(rpDashboardCmi2);
	}
	...
	public static RpDashboardCmi2 fetchRpDashboardCmi2(long id) {
		return getService().fetchRpDashboardCmi2(id);
	}
	...
	public static List<RpDashboardCmi2> getBaoCaoCmiBo_Tinh(
		String maDonVi, int type) {

		return getService().getBaoCaoCmiBo_Tinh(maDonVi, type);
	}
	 ...
	 * @throws PortalException if a rp dashboard cmi2 with the primary key could not be found
	 */
	public static RpDashboardCmi2 getRpDashboardCmi2(long id)
		throws PortalException {

		return getService().getRpDashboardCmi2(id);
	}
	 ...
	 */
	public static List<RpDashboardCmi2> getRpDashboardCmi2s(
		int start, int end) {

		return getService().getRpDashboardCmi2s(start, end);
	}
	 ...
	 */
	public static int getRpDashboardCmi2sCount() {
		return getService().getRpDashboardCmi2sCount();
	}
	 ...
	 */
	public static RpDashboardCmi2 updateRpDashboardCmi2(
		RpDashboardCmi2 rpDashboardCmi2) {

		return getService().updateRpDashboardCmi2(rpDashboardCmi2);
	}

	public static RpDashboardCmi2LocalService getService() {
		return _service;
	}

	private static volatile RpDashboardCmi2LocalService _service;
