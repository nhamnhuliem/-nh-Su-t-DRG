...
/**
 * The persistence interface for the rp dashboard chi phi binh quan service.
 *
 * <p>
 ...
 *
 * @author SON
 * @see RpDashboardChiPhiBinhQuanUtil
 * @generated
 */
@ProviderType
public interface RpDashboardChiPhiBinhQuanPersistence
	extends BasePersistence<RpDashboardChiPhiBinhQuan> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RpDashboardChiPhiBinhQuanUtil} to access the rp dashboard chi phi binh quan persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(
		java.util.List<RpDashboardChiPhiBinhQuan> rpDashboardChiPhiBinhQuans);
	 ...
	 */
	public java.util.List<RpDashboardChiPhiBinhQuan> findAll();
	...
	public java.util.List<RpDashboardChiPhiBinhQuan> findAll(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<RpDashboardChiPhiBinhQuan> orderByComparator);
