...
/**
 * The persistence utility for the rp dashboard cmi3 service. This utility wraps <code>drg.moh.service.service.persistence.impl.RpDashboardCmi3PersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author SON
 * @see RpDashboardCmi3Persistence
 * @generated
 */
public class RpDashboardCmi3Util {
	 ...
	 */
	public static void clearCache(RpDashboardCmi3 rpDashboardCmi3) {
		getPersistence().clearCache(rpDashboardCmi3);
	}
	 ...
	 */
	public static Map<Serializable, RpDashboardCmi3> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RpDashboardCmi3> findWithDynamicQuery(
	 ...
	 */
	public static RpDashboardCmi3 update(RpDashboardCmi3 rpDashboardCmi3) {
		return getPersistence().update(rpDashboardCmi3);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static RpDashboardCmi3 update(
		RpDashboardCmi3 rpDashboardCmi3, ServiceContext serviceContext) {

		return getPersistence().update(rpDashboardCmi3, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(RpDashboardCmi3 rpDashboardCmi3) {
		getPersistence().cacheResult(rpDashboardCmi3);
	}
	 ...
	 */
	public static void cacheResult(List<RpDashboardCmi3> rpDashboardCmi3s) {
		getPersistence().cacheResult(rpDashboardCmi3s);
	}
	 ...
	 */
	public static RpDashboardCmi3 create(long id) {
	 ...
	 */
	public static RpDashboardCmi3 remove(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardCmi3Exception {

		return getPersistence().remove(id);
	}

	public static RpDashboardCmi3 updateImpl(RpDashboardCmi3 rpDashboardCmi3) {
		return getPersistence().updateImpl(rpDashboardCmi3);
	}
	 ...
	 * @throws NoSuchRpDashboardCmi3Exception if a rp dashboard cmi3 with the primary key could not be found
	 */
	public static RpDashboardCmi3 findByPrimaryKey(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardCmi3Exception {
	 ...
	 */
	public static RpDashboardCmi3 fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<RpDashboardCmi3> findAll() {
	 ...
	 */
	public static List<RpDashboardCmi3> findAll(int start, int end) {
	...
	public static RpDashboardCmi3Persistence getPersistence() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RpDashboardCmi3Persistence.class);

		ServiceTracker<RpDashboardCmi3Persistence, RpDashboardCmi3Persistence>
			serviceTracker =
				new ServiceTracker
					<RpDashboardCmi3Persistence, RpDashboardCmi3Persistence>(
						bundle.getBundleContext(),
						RpDashboardCmi3Persistence.class, null);
