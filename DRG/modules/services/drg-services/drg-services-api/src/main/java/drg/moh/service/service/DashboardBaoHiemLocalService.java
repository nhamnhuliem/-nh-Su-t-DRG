...
/**
 * Provides the local service interface for DashboardBaoHiem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SON
 * @see DashboardBaoHiemLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DashboardBaoHiemLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>drg.moh.service.service.impl.DashboardBaoHiemLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dashboard bao hiem local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DashboardBaoHiemLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DashboardBaoHiem getDashboardBaoHiem(long id) throws PortalException;
