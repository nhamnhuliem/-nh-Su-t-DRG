...
/**
 * The persistence interface for the rp dashboard trung binh service.
 *
 * <p>
 ...
 *
 * @author SON
 * @see RpDashboardTrungBinhUtil
 * @generated
 */
@ProviderType
public interface RpDashboardTrungBinhPersistence
	extends BasePersistence<RpDashboardTrungBinh> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RpDashboardTrungBinhUtil} to access the rp dashboard trung binh persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<RpDashboardTrungBinh> rpDashboardTrungBinhs);
	 ...
	 */
	public java.util.List<RpDashboardTrungBinh> findAll();
	 ...
	 */
	public java.util.List<RpDashboardTrungBinh> findAll(int start, int end);
	...
	public java.util.List<RpDashboardTrungBinh> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<RpDashboardTrungBinh>
			orderByComparator);
