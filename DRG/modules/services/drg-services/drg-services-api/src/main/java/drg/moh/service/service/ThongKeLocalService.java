...
/**
 * Provides the local service interface for ThongKe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SON
 * @see ThongKeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ThongKeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>drg.moh.service.service.impl.ThongKeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the thong ke local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ThongKeLocalServiceUtil} if injection and service tracking are not available.
	 */
