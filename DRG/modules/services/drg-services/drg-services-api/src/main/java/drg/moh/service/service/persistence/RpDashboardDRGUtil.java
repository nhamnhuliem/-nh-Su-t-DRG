...
/**
 * The persistence utility for the rp dashboard drg service. This utility wraps <code>drg.moh.service.service.persistence.impl.RpDashboardDRGPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author SON
 * @see RpDashboardDRGPersistence
 * @generated
 */
public class RpDashboardDRGUtil {
	 ...
	 */
	public static void clearCache(RpDashboardDRG rpDashboardDRG) {
		getPersistence().clearCache(rpDashboardDRG);
	}
	 ...
	 */
	public static Map<Serializable, RpDashboardDRG> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RpDashboardDRG> findWithDynamicQuery(
	 ...
	 */
	public static RpDashboardDRG update(RpDashboardDRG rpDashboardDRG) {
		return getPersistence().update(rpDashboardDRG);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static RpDashboardDRG update(
		RpDashboardDRG rpDashboardDRG, ServiceContext serviceContext) {

		return getPersistence().update(rpDashboardDRG, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(RpDashboardDRG rpDashboardDRG) {
		getPersistence().cacheResult(rpDashboardDRG);
	}
	 ...
	 */
	public static void cacheResult(List<RpDashboardDRG> rpDashboardDRGs) {
		getPersistence().cacheResult(rpDashboardDRGs);
	}
	 ...
	 */
	public static RpDashboardDRG create(long id) {
	 ...
	 */
	public static RpDashboardDRG remove(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardDRGException {

		return getPersistence().remove(id);
	}

	public static RpDashboardDRG updateImpl(RpDashboardDRG rpDashboardDRG) {
		return getPersistence().updateImpl(rpDashboardDRG);
	}
	 ...
	 * @throws NoSuchRpDashboardDRGException if a rp dashboard drg with the primary key could not be found
	 */
	public static RpDashboardDRG findByPrimaryKey(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardDRGException {
	 ...
	 */
	public static RpDashboardDRG fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<RpDashboardDRG> findAll() {
	 ...
	 */
	public static List<RpDashboardDRG> findAll(int start, int end) {
	...
	public static RpDashboardDRGPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<RpDashboardDRGPersistence, RpDashboardDRGPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RpDashboardDRGPersistence.class);

		ServiceTracker<RpDashboardDRGPersistence, RpDashboardDRGPersistence>
			serviceTracker =
				new ServiceTracker
					<RpDashboardDRGPersistence, RpDashboardDRGPersistence>(
						bundle.getBundleContext(),
						RpDashboardDRGPersistence.class, null);
