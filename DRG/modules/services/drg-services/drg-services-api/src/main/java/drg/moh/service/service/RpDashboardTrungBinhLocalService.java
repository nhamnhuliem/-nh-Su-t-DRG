...
/**
 * Provides the local service interface for RpDashboardTrungBinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SON
 * @see RpDashboardTrungBinhLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RpDashboardTrungBinhLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>drg.moh.service.service.impl.RpDashboardTrungBinhLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rp dashboard trung binh local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RpDashboardTrungBinhLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RpDashboardTrungBinh addRpDashboardTrungBinh(
	...
	public RpDashboardTrungBinh createRpDashboardTrungBinh(String data);
	...
	public RpDashboardTrungBinh deleteRpDashboardTrungBinh(
		RpDashboardTrungBinh rpDashboardTrungBinh);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RpDashboardTrungBinh deleteRpDashboardTrungBinh(String data)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RpDashboardTrungBinh fetchRpDashboardTrungBinh(String data);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RpDashboardTrungBinh getRpDashboardTrungBinh(String data)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RpDashboardTrungBinh> getRpDashboardTrungBinhs(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RpDashboardTrungBinh updateRpDashboardTrungBinh(
		RpDashboardTrungBinh rpDashboardTrungBinh);
