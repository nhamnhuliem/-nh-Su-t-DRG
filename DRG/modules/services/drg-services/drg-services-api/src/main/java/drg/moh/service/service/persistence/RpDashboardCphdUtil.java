...
/**
 * The persistence utility for the rp dashboard cphd service. This utility wraps <code>drg.moh.service.service.persistence.impl.RpDashboardCphdPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author SON
 * @see RpDashboardCphdPersistence
 * @generated
 */
public class RpDashboardCphdUtil {
	 ...
	 */
	public static void clearCache(RpDashboardCphd rpDashboardCphd) {
		getPersistence().clearCache(rpDashboardCphd);
	}
	 ...
	 */
	public static Map<Serializable, RpDashboardCphd> fetchByPrimaryKeys(
	 ...
	 */
	public static List<RpDashboardCphd> findWithDynamicQuery(
	 ...
	 */
	public static RpDashboardCphd update(RpDashboardCphd rpDashboardCphd) {
		return getPersistence().update(rpDashboardCphd);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static RpDashboardCphd update(
		RpDashboardCphd rpDashboardCphd, ServiceContext serviceContext) {

		return getPersistence().update(rpDashboardCphd, serviceContext);
	}
	 ...
	 */
	public static void cacheResult(RpDashboardCphd rpDashboardCphd) {
		getPersistence().cacheResult(rpDashboardCphd);
	}
	 ...
	 */
	public static void cacheResult(List<RpDashboardCphd> rpDashboardCphds) {
		getPersistence().cacheResult(rpDashboardCphds);
	}
	 ...
	 */
	public static RpDashboardCphd create(long id) {
	 ...
	 */
	public static RpDashboardCphd remove(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardCphdException {

		return getPersistence().remove(id);
	}

	public static RpDashboardCphd updateImpl(RpDashboardCphd rpDashboardCphd) {
		return getPersistence().updateImpl(rpDashboardCphd);
	}
	 ...
	 * @throws NoSuchRpDashboardCphdException if a rp dashboard cphd with the primary key could not be found
	 */
	public static RpDashboardCphd findByPrimaryKey(long id)
		throws drg.moh.service.exception.NoSuchRpDashboardCphdException {
	 ...
	 */
	public static RpDashboardCphd fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<RpDashboardCphd> findAll() {
	 ...
	 */
	public static List<RpDashboardCphd> findAll(int start, int end) {
	...
	public static RpDashboardCphdPersistence getPersistence() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			RpDashboardCphdPersistence.class);

		ServiceTracker<RpDashboardCphdPersistence, RpDashboardCphdPersistence>
			serviceTracker =
				new ServiceTracker
					<RpDashboardCphdPersistence, RpDashboardCphdPersistence>(
						bundle.getBundleContext(),
						RpDashboardCphdPersistence.class, null);
