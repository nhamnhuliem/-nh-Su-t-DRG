...
/**
 * Provides the local service utility for DashboardChiPhiThanhPhan. This utility wraps
 * <code>drg.moh.service.service.impl.DashboardChiPhiThanhPhanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DashboardChiPhiThanhPhanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>drg.moh.service.service.impl.DashboardChiPhiThanhPhanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DashboardChiPhiThanhPhan addDashboardChiPhiThanhPhan(
		DashboardChiPhiThanhPhan dashboardChiPhiThanhPhan) {

		return getService().addDashboardChiPhiThanhPhan(
	 ...
	 */
	public static DashboardChiPhiThanhPhan createDashboardChiPhiThanhPhan(
		long id) {

		return getService().createDashboardChiPhiThanhPhan(id);
	}
	 ...
	 */
	public static DashboardChiPhiThanhPhan deleteDashboardChiPhiThanhPhan(
		DashboardChiPhiThanhPhan dashboardChiPhiThanhPhan) {

		return getService().deleteDashboardChiPhiThanhPhan(
			dashboardChiPhiThanhPhan);
	}
	...
	public static DashboardChiPhiThanhPhan deleteDashboardChiPhiThanhPhan(
		...
		return getService().deleteDashboardChiPhiThanhPhan(id);
	}
	...
	public static DashboardChiPhiThanhPhan fetchDashboardChiPhiThanhPhan(
		long id) {

		return getService().fetchDashboardChiPhiThanhPhan(id);
	}
	 ...
	 * @throws PortalException if a dashboard chi phi thanh phan with the primary key could not be found
	 */
	public static DashboardChiPhiThanhPhan getDashboardChiPhiThanhPhan(long id)
		throws PortalException {

		return getService().getDashboardChiPhiThanhPhan(id);
	}
	 ...
	 */
	public static List<DashboardChiPhiThanhPhan> getDashboardChiPhiThanhPhans(
		int start, int end) {

		return getService().getDashboardChiPhiThanhPhans(start, end);
	}
	 ...
	 */
	public static int getDashboardChiPhiThanhPhansCount() {
		return getService().getDashboardChiPhiThanhPhansCount();
	}
	 ...
	 */
	public static DashboardChiPhiThanhPhan updateDashboardChiPhiThanhPhan(
		DashboardChiPhiThanhPhan dashboardChiPhiThanhPhan) {

		return getService().updateDashboardChiPhiThanhPhan(
			dashboardChiPhiThanhPhan);
	}

	public static DashboardChiPhiThanhPhanLocalService getService() {
		return _service;
	}

	private static volatile DashboardChiPhiThanhPhanLocalService _service;
