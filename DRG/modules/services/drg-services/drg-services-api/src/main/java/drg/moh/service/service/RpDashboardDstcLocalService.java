...
/**
 * Provides the local service interface for RpDashboardDstc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SON
 * @see RpDashboardDstcLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RpDashboardDstcLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>drg.moh.service.service.impl.RpDashboardDstcLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rp dashboard dstc local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RpDashboardDstcLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RpDashboardDstc addRpDashboardDstc(RpDashboardDstc rpDashboardDstc);
	...
	public RpDashboardDstc createRpDashboardDstc(String id);
	...
	public RpDashboardDstc deleteRpDashboardDstc(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RpDashboardDstc deleteRpDashboardDstc(String id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RpDashboardDstc fetchRpDashboardDstc(String id);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RpDashboardDstc> getReportDinhSuatTieuChuan(
			String orgId, int type)
		throws SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RpDashboardDstc> getReportSoLuongBenhNhanDinhSuat(
		String maDonVi, int type, int getBy);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RpDashboardDstc> getReportSoLuongBenhNhanDRG(
		String maDonVi, int type, int getBy);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RpDashboardDstc getRpDashboardDstc(String id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RpDashboardDstc> getRpDashboardDstcs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RpDashboardDstc updateRpDashboardDstc(
		RpDashboardDstc rpDashboardDstc);
