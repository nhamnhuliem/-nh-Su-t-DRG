...
/**
 * Provides the local service interface for RpDashboardCmi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SON
 * @see RpDashboardCmiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RpDashboardCmiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>drg.moh.service.service.impl.RpDashboardCmiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rp dashboard cmi local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RpDashboardCmiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<DashboardCMI> findByORG_MUC_NAM(long orgId, int mucBc, int nam)
