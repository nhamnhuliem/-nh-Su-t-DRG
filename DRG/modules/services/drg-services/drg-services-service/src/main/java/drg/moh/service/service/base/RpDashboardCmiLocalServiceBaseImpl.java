...
import drg.moh.service.service.RpDashboardCmiLocalService;
...
/**
 * Provides the base implementation for the rp dashboard cmi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardCmiLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardCmiLocalServiceImpl
 * @generated
 */
public abstract class RpDashboardCmiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RpDashboardCmiLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardCmiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardCmiLocalServiceUtil</code>.
	 */
	...
	@Override
	public RpDashboardCmi addRpDashboardCmi(RpDashboardCmi rpDashboardCmi) {
		rpDashboardCmi.setNew(true);

		return rpDashboardCmiPersistence.update(rpDashboardCmi);
	}
	...
	public RpDashboardCmi createRpDashboardCmi(long id) {
		return rpDashboardCmiPersistence.create(id);
	}
	...
	@Override
	public RpDashboardCmi deleteRpDashboardCmi(long id) throws PortalException {
		return rpDashboardCmiPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RpDashboardCmi deleteRpDashboardCmi(RpDashboardCmi rpDashboardCmi) {
		return rpDashboardCmiPersistence.remove(rpDashboardCmi);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rpDashboardCmiPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RpDashboardCmi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rpDashboardCmiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rpDashboardCmiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rpDashboardCmiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rpDashboardCmiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RpDashboardCmi fetchRpDashboardCmi(long id) {
		return rpDashboardCmiPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RpDashboardCmi getRpDashboardCmi(long id) throws PortalException {
		return rpDashboardCmiPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rpDashboardCmiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RpDashboardCmi.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RpDashboardCmi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardCmiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return rpDashboardCmiLocalService.deleteRpDashboardCmi(
			(RpDashboardCmi)persistedModel);
	}

	@Override
	public BasePersistence<RpDashboardCmi> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardCmiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RpDashboardCmi> getRpDashboardCmis(int start, int end) {
		return rpDashboardCmiPersistence.findAll(start, end);
	}
	...
	public int getRpDashboardCmisCount() {
		return rpDashboardCmiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RpDashboardCmi updateRpDashboardCmi(RpDashboardCmi rpDashboardCmi) {
		return rpDashboardCmiPersistence.update(rpDashboardCmi);
	}
	 ...
	 */
	public RpDashboardCmiLocalService getRpDashboardCmiLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.RpDashboardCmi", rpDashboardCmiLocalService);

		_setLocalServiceUtilService(rpDashboardCmiLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"drg.moh.service.model.RpDashboardCmi");
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardCmiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rpDashboardCmiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = RpDashboardCmiLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardCmiLocalService);
		}
	...
	@BeanReference(type = RpDashboardCmiLocalService.class)
	protected RpDashboardCmiLocalService rpDashboardCmiLocalService;
