...
import drg.moh.service.service.RpDashboardDRGLocalService;
...
/**
 * Provides the base implementation for the rp dashboard drg local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardDRGLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardDRGLocalServiceImpl
 * @generated
 */
public abstract class RpDashboardDRGLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RpDashboardDRGLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardDRGLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardDRGLocalServiceUtil</code>.
	 */
	...
	@Override
	public RpDashboardDRG addRpDashboardDRG(RpDashboardDRG rpDashboardDRG) {
		rpDashboardDRG.setNew(true);

		return rpDashboardDRGPersistence.update(rpDashboardDRG);
	}
	...
	public RpDashboardDRG createRpDashboardDRG(long id) {
		return rpDashboardDRGPersistence.create(id);
	}
	...
	@Override
	public RpDashboardDRG deleteRpDashboardDRG(long id) throws PortalException {
		return rpDashboardDRGPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RpDashboardDRG deleteRpDashboardDRG(RpDashboardDRG rpDashboardDRG) {
		return rpDashboardDRGPersistence.remove(rpDashboardDRG);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rpDashboardDRGPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RpDashboardDRG.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rpDashboardDRGPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rpDashboardDRGPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rpDashboardDRGPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rpDashboardDRGPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RpDashboardDRG fetchRpDashboardDRG(long id) {
		return rpDashboardDRGPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RpDashboardDRG getRpDashboardDRG(long id) throws PortalException {
		return rpDashboardDRGPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rpDashboardDRGLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RpDashboardDRG.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RpDashboardDRG.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardDRGPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return rpDashboardDRGLocalService.deleteRpDashboardDRG(
			(RpDashboardDRG)persistedModel);
	}

	@Override
	public BasePersistence<RpDashboardDRG> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardDRGPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RpDashboardDRG> getRpDashboardDRGs(int start, int end) {
		return rpDashboardDRGPersistence.findAll(start, end);
	}
	...
	public int getRpDashboardDRGsCount() {
		return rpDashboardDRGPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RpDashboardDRG updateRpDashboardDRG(RpDashboardDRG rpDashboardDRG) {
		return rpDashboardDRGPersistence.update(rpDashboardDRG);
	}
	 ...
	 */
	public RpDashboardDRGLocalService getRpDashboardDRGLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.RpDashboardDRG", rpDashboardDRGLocalService);

		_setLocalServiceUtilService(rpDashboardDRGLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"drg.moh.service.model.RpDashboardDRG");
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardDRGLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rpDashboardDRGPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = RpDashboardDRGLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardDRGLocalService);
		}
	...
	@BeanReference(type = RpDashboardDRGLocalService.class)
	protected RpDashboardDRGLocalService rpDashboardDRGLocalService;
