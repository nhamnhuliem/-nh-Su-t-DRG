...
import drg.moh.service.service.RpDashboardDstcService;
import drg.moh.service.service.RpDashboardDstcServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard dstc remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardDstcServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardDstcServiceImpl
 * @generated
 */
public abstract class RpDashboardDstcServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardDstcService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardDstcService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardDstcServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardDstcService getRpDashboardDstcService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardDstcService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardDstcService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rpDashboardDstcPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RpDashboardDstcServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardDstcService);
		}
	...
	@BeanReference(type = RpDashboardDstcService.class)
	protected RpDashboardDstcService rpDashboardDstcService;
