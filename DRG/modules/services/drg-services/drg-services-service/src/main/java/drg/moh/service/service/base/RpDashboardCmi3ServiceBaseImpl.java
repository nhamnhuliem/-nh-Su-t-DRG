...
import drg.moh.service.service.RpDashboardCmi3Service;
import drg.moh.service.service.RpDashboardCmi3ServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard cmi3 remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardCmi3ServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardCmi3ServiceImpl
 * @generated
 */
public abstract class RpDashboardCmi3ServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardCmi3Service {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardCmi3Service</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardCmi3ServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardCmi3Service getRpDashboardCmi3Service() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardCmi3Service);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardCmi3Service.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RpDashboardCmi3ServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardCmi3Service);
		}
	...
	@BeanReference(type = RpDashboardCmi3Service.class)
	protected RpDashboardCmi3Service rpDashboardCmi3Service;
