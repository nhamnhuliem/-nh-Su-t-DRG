...
import drg.moh.service.service.RpDashboardDstcChiTietService;
import drg.moh.service.service.RpDashboardDstcChiTietServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard dstc chi tiet remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardDstcChiTietServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardDstcChiTietServiceImpl
 * @generated
 */
public abstract class RpDashboardDstcChiTietServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardDstcChiTietService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardDstcChiTietService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardDstcChiTietServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardDstcChiTietService getRpDashboardDstcChiTietService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardDstcChiTietService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardDstcChiTietService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				rpDashboardDstcChiTietPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RpDashboardDstcChiTietServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardDstcChiTietService);
		}
	...
	@BeanReference(type = RpDashboardDstcChiTietService.class)
	protected RpDashboardDstcChiTietService rpDashboardDstcChiTietService;
