...
import drg.moh.service.service.RpDashboardTrungBinhService;
import drg.moh.service.service.RpDashboardTrungBinhServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard trung binh remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardTrungBinhServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardTrungBinhServiceImpl
 * @generated
 */
public abstract class RpDashboardTrungBinhServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardTrungBinhService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardTrungBinhService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardTrungBinhServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardTrungBinhService getRpDashboardTrungBinhService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardTrungBinhService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardTrungBinhService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				rpDashboardTrungBinhPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RpDashboardTrungBinhServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardTrungBinhService);
		}
	...
	@BeanReference(type = RpDashboardTrungBinhService.class)
	protected RpDashboardTrungBinhService rpDashboardTrungBinhService;
