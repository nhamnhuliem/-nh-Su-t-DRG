...
import drg.moh.service.service.RpDashboardChiPhiBinhQuanService;
import drg.moh.service.service.RpDashboardChiPhiBinhQuanServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard chi phi binh quan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardChiPhiBinhQuanServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardChiPhiBinhQuanServiceImpl
 * @generated
 */
public abstract class RpDashboardChiPhiBinhQuanServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardChiPhiBinhQuanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardChiPhiBinhQuanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardChiPhiBinhQuanServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardChiPhiBinhQuanService
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardChiPhiBinhQuanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardChiPhiBinhQuanService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RpDashboardChiPhiBinhQuanServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardChiPhiBinhQuanService);
		}
	...
	@BeanReference(type = RpDashboardChiPhiBinhQuanService.class)
	protected RpDashboardChiPhiBinhQuanService rpDashboardChiPhiBinhQuanService;
