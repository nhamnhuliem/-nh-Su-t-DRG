...
import drg.moh.service.service.DashboardCMILocalService;
...
/**
 * Provides the base implementation for the dashboard cmi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.DashboardCMILocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.DashboardCMILocalServiceImpl
 * @generated
 */
public abstract class DashboardCMILocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DashboardCMILocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DashboardCMILocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DashboardCMILocalServiceUtil</code>.
	 */
	...
	@Override
	public DashboardCMI addDashboardCMI(DashboardCMI dashboardCMI) {
		dashboardCMI.setNew(true);

		return dashboardCMIPersistence.update(dashboardCMI);
	}
	...
	public DashboardCMI createDashboardCMI(long id) {
		return dashboardCMIPersistence.create(id);
	}
	...
	@Override
	public DashboardCMI deleteDashboardCMI(long id) throws PortalException {
		return dashboardCMIPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DashboardCMI deleteDashboardCMI(DashboardCMI dashboardCMI) {
		return dashboardCMIPersistence.remove(dashboardCMI);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dashboardCMIPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DashboardCMI.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dashboardCMIPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dashboardCMIPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dashboardCMIPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dashboardCMIPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DashboardCMI fetchDashboardCMI(long id) {
		return dashboardCMIPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DashboardCMI getDashboardCMI(long id) throws PortalException {
		return dashboardCMIPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dashboardCMILocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DashboardCMI.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DashboardCMI.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardCMIPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return dashboardCMILocalService.deleteDashboardCMI(
			(DashboardCMI)persistedModel);
	}

	@Override
	public BasePersistence<DashboardCMI> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardCMIPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DashboardCMI> getDashboardCMIs(int start, int end) {
		return dashboardCMIPersistence.findAll(start, end);
	}
	...
	public int getDashboardCMIsCount() {
		return dashboardCMIPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DashboardCMI updateDashboardCMI(DashboardCMI dashboardCMI) {
		return dashboardCMIPersistence.update(dashboardCMI);
	}
	 ...
	 */
	public DashboardCMILocalService getDashboardCMILocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.DashboardCMI", dashboardCMILocalService);

		_setLocalServiceUtilService(dashboardCMILocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"drg.moh.service.model.DashboardCMI");
	...
	public String getOSGiServiceIdentifier() {
		return DashboardCMILocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dashboardCMIPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DashboardCMILocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dashboardCMILocalService);
		}
	...
	@BeanReference(type = DashboardCMILocalService.class)
	protected DashboardCMILocalService dashboardCMILocalService;
