...
import drg.moh.service.service.DashboardBaoHiemLocalService;
...
/**
 * Provides the base implementation for the dashboard bao hiem local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.DashboardBaoHiemLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.DashboardBaoHiemLocalServiceImpl
 * @generated
 */
public abstract class DashboardBaoHiemLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DashboardBaoHiemLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DashboardBaoHiemLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DashboardBaoHiemLocalServiceUtil</code>.
	 */
	...
	@Override
	public DashboardBaoHiem addDashboardBaoHiem(
		DashboardBaoHiem dashboardBaoHiem) {

		dashboardBaoHiem.setNew(true);

		return dashboardBaoHiemPersistence.update(dashboardBaoHiem);
	}
	...
	public DashboardBaoHiem createDashboardBaoHiem(long id) {
		return dashboardBaoHiemPersistence.create(id);
	}
	...
	@Override
	public DashboardBaoHiem deleteDashboardBaoHiem(long id)
		throws PortalException {

		return dashboardBaoHiemPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DashboardBaoHiem deleteDashboardBaoHiem(
		DashboardBaoHiem dashboardBaoHiem) {

		return dashboardBaoHiemPersistence.remove(dashboardBaoHiem);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dashboardBaoHiemPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DashboardBaoHiem.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dashboardBaoHiemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dashboardBaoHiemPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dashboardBaoHiemPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dashboardBaoHiemPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DashboardBaoHiem fetchDashboardBaoHiem(long id) {
		return dashboardBaoHiemPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DashboardBaoHiem getDashboardBaoHiem(long id)
		throws PortalException {

		return dashboardBaoHiemPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DashboardBaoHiem.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DashboardBaoHiem.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardBaoHiemPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return dashboardBaoHiemLocalService.deleteDashboardBaoHiem(
			(DashboardBaoHiem)persistedModel);
	}

	@Override
	public BasePersistence<DashboardBaoHiem> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardBaoHiemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DashboardBaoHiem> getDashboardBaoHiems(int start, int end) {
		return dashboardBaoHiemPersistence.findAll(start, end);
	}
	...
	public int getDashboardBaoHiemsCount() {
		return dashboardBaoHiemPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DashboardBaoHiem updateDashboardBaoHiem(
		DashboardBaoHiem dashboardBaoHiem) {
	 ...
	 */
	public DashboardBaoHiemLocalService getDashboardBaoHiemLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.DashboardBaoHiem",
			dashboardBaoHiemLocalService);

		_setLocalServiceUtilService(dashboardBaoHiemLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DashboardBaoHiemLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dashboardBaoHiemPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DashboardBaoHiemLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dashboardBaoHiemLocalService);
		}
	...
	@BeanReference(type = DashboardBaoHiemLocalService.class)
	protected DashboardBaoHiemLocalService dashboardBaoHiemLocalService;
