...
import drg.moh.service.service.DashboardChiPhiBinhQuanLocalService;
...
/**
 * Provides the base implementation for the dashboard chi phi binh quan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.DashboardChiPhiBinhQuanLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.DashboardChiPhiBinhQuanLocalServiceImpl
 * @generated
 */
public abstract class DashboardChiPhiBinhQuanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements DashboardChiPhiBinhQuanLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DashboardChiPhiBinhQuanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DashboardChiPhiBinhQuanLocalServiceUtil</code>.
	 */
	...
	@Override
	public DashboardChiPhiBinhQuan addDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {

		dashboardChiPhiBinhQuan.setNew(true);

		return dashboardChiPhiBinhQuanPersistence.update(
	...
	public DashboardChiPhiBinhQuan createDashboardChiPhiBinhQuan(long id) {
		return dashboardChiPhiBinhQuanPersistence.create(id);
	}
	...
	@Override
	public DashboardChiPhiBinhQuan deleteDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return dashboardChiPhiBinhQuanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DashboardChiPhiBinhQuan deleteDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {

		return dashboardChiPhiBinhQuanPersistence.remove(
			dashboardChiPhiBinhQuan);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dashboardChiPhiBinhQuanPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DashboardChiPhiBinhQuan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dashboardChiPhiBinhQuanPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dashboardChiPhiBinhQuanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public DashboardChiPhiBinhQuan fetchDashboardChiPhiBinhQuan(long id) {
		return dashboardChiPhiBinhQuanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DashboardChiPhiBinhQuan getDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return dashboardChiPhiBinhQuanPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(DashboardChiPhiBinhQuan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardChiPhiBinhQuanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return dashboardChiPhiBinhQuanLocalService.
			deleteDashboardChiPhiBinhQuan(
				(DashboardChiPhiBinhQuan)persistedModel);
	}

	@Override
	public BasePersistence<DashboardChiPhiBinhQuan> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dashboardChiPhiBinhQuanPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DashboardChiPhiBinhQuan> getDashboardChiPhiBinhQuans(
		int start, int end) {

		return dashboardChiPhiBinhQuanPersistence.findAll(start, end);
	}
	...
	public int getDashboardChiPhiBinhQuansCount() {
		return dashboardChiPhiBinhQuanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DashboardChiPhiBinhQuan updateDashboardChiPhiBinhQuan(
		DashboardChiPhiBinhQuan dashboardChiPhiBinhQuan) {
	 ...
	 */
	public DashboardChiPhiBinhQuanLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(dashboardChiPhiBinhQuanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DashboardChiPhiBinhQuanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dashboardChiPhiBinhQuanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DashboardChiPhiBinhQuanLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dashboardChiPhiBinhQuanLocalService);
		}
	...
	@BeanReference(type = DashboardChiPhiBinhQuanLocalService.class)
	protected DashboardChiPhiBinhQuanLocalService
		dashboardChiPhiBinhQuanLocalService;
