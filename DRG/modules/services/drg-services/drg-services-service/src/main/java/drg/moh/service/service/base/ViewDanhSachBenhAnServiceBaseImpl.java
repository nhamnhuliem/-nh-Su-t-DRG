...
import drg.moh.service.service.ViewDanhSachBenhAnService;
import drg.moh.service.service.ViewDanhSachBenhAnServiceUtil;
...
/**
 * Provides the base implementation for the view danh sach benh an remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.ViewDanhSachBenhAnServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.ViewDanhSachBenhAnServiceImpl
 * @generated
 */
public abstract class ViewDanhSachBenhAnServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, ViewDanhSachBenhAnService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ViewDanhSachBenhAnService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ViewDanhSachBenhAnServiceUtil</code>.
	 */
	 ...
	 */
	public ViewDanhSachBenhAnService getViewDanhSachBenhAnService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(viewDanhSachBenhAnService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ViewDanhSachBenhAnService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ViewDanhSachBenhAnServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, viewDanhSachBenhAnService);
		}
	...
	@BeanReference(type = ViewDanhSachBenhAnService.class)
	protected ViewDanhSachBenhAnService viewDanhSachBenhAnService;
