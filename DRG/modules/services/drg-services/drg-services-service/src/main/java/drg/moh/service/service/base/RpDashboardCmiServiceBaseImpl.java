...
import drg.moh.service.service.RpDashboardCmiService;
import drg.moh.service.service.RpDashboardCmiServiceUtil;
...
/**
 * Provides the base implementation for the rp dashboard cmi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardCmiServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardCmiServiceImpl
 * @generated
 */
public abstract class RpDashboardCmiServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RpDashboardCmiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardCmiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardCmiServiceUtil</code>.
	 */
	 ...
	 */
	public RpDashboardCmiService getRpDashboardCmiService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(rpDashboardCmiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardCmiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RpDashboardCmiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardCmiService);
		}
	...
	@BeanReference(type = RpDashboardCmiService.class)
	protected RpDashboardCmiService rpDashboardCmiService;
