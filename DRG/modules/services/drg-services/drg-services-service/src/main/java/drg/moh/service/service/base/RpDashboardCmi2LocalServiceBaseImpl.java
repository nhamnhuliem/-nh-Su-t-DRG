...
import drg.moh.service.service.RpDashboardCmi2LocalService;
...
/**
 * Provides the base implementation for the rp dashboard cmi2 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardCmi2LocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardCmi2LocalServiceImpl
 * @generated
 */
public abstract class RpDashboardCmi2LocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RpDashboardCmi2LocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardCmi2LocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardCmi2LocalServiceUtil</code>.
	 */
	...
	@Override
	public RpDashboardCmi2 addRpDashboardCmi2(RpDashboardCmi2 rpDashboardCmi2) {
		rpDashboardCmi2.setNew(true);

		return rpDashboardCmi2Persistence.update(rpDashboardCmi2);
	}
	...
	public RpDashboardCmi2 createRpDashboardCmi2(long id) {
		return rpDashboardCmi2Persistence.create(id);
	}
	...
	@Override
	public RpDashboardCmi2 deleteRpDashboardCmi2(long id)
		throws PortalException {

		return rpDashboardCmi2Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RpDashboardCmi2 deleteRpDashboardCmi2(
		RpDashboardCmi2 rpDashboardCmi2) {

		return rpDashboardCmi2Persistence.remove(rpDashboardCmi2);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rpDashboardCmi2Persistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RpDashboardCmi2.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rpDashboardCmi2Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return rpDashboardCmi2Persistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rpDashboardCmi2Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return rpDashboardCmi2Persistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RpDashboardCmi2 fetchRpDashboardCmi2(long id) {
		return rpDashboardCmi2Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RpDashboardCmi2 getRpDashboardCmi2(long id) throws PortalException {
		return rpDashboardCmi2Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(rpDashboardCmi2LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RpDashboardCmi2.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(RpDashboardCmi2.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardCmi2Persistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return rpDashboardCmi2LocalService.deleteRpDashboardCmi2(
			(RpDashboardCmi2)persistedModel);
	}

	@Override
	public BasePersistence<RpDashboardCmi2> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardCmi2Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RpDashboardCmi2> getRpDashboardCmi2s(int start, int end) {
		return rpDashboardCmi2Persistence.findAll(start, end);
	}
	...
	public int getRpDashboardCmi2sCount() {
		return rpDashboardCmi2Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RpDashboardCmi2 updateRpDashboardCmi2(
		RpDashboardCmi2 rpDashboardCmi2) {
	 ...
	 */
	public RpDashboardCmi2LocalService getRpDashboardCmi2LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.RpDashboardCmi2",
			rpDashboardCmi2LocalService);

		_setLocalServiceUtilService(rpDashboardCmi2LocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardCmi2LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rpDashboardCmi2Persistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				RpDashboardCmi2LocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, rpDashboardCmi2LocalService);
		}
	...
	@BeanReference(type = RpDashboardCmi2LocalService.class)
	protected RpDashboardCmi2LocalService rpDashboardCmi2LocalService;
