...
import drg.moh.service.service.ThongKeLocalService;
...
/**
 * Provides the base implementation for the thong ke local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.ThongKeLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.ThongKeLocalServiceImpl
 * @generated
 */
public abstract class ThongKeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, ThongKeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ThongKeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ThongKeLocalServiceUtil</code>.
	 */
	...
	@Override
	public ThongKe addThongKe(ThongKe thongKe) {
		thongKe.setNew(true);

		return thongKePersistence.update(thongKe);
	}
	...
	public ThongKe createThongKe(long id) {
		return thongKePersistence.create(id);
	}
	...
	@Override
	public ThongKe deleteThongKe(long id) throws PortalException {
		return thongKePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ThongKe deleteThongKe(ThongKe thongKe) {
		return thongKePersistence.remove(thongKe);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return thongKePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ThongKe.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return thongKePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return thongKePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return thongKePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return thongKePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ThongKe fetchThongKe(long id) {
		return thongKePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ThongKe getThongKe(long id) throws PortalException {
		return thongKePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(thongKeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ThongKe.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ThongKe.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return thongKePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return thongKeLocalService.deleteThongKe((ThongKe)persistedModel);
	}

	@Override
	public BasePersistence<ThongKe> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return thongKePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ThongKe> getThongKes(int start, int end) {
		return thongKePersistence.findAll(start, end);
	}
	...
	public int getThongKesCount() {
		return thongKePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ThongKe updateThongKe(ThongKe thongKe) {
		return thongKePersistence.update(thongKe);
	}
	 ...
	 */
	public ThongKeLocalService getThongKeLocalService() {
	...
	public void setThongKeLocalService(
		ThongKeLocalService thongKeLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"drg.moh.service.model.ThongKe", thongKeLocalService);

		_setLocalServiceUtilService(thongKeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"drg.moh.service.model.ThongKe");
	...
	public String getOSGiServiceIdentifier() {
		return ThongKeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = thongKePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ThongKeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, thongKeLocalService);
		}
	...
	@BeanReference(type = ThongKeLocalService.class)
	protected ThongKeLocalService thongKeLocalService;
