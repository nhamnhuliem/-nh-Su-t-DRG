...
import drg.moh.service.service.ThongKeBaoCaoService;
import drg.moh.service.service.ThongKeBaoCaoServiceUtil;
...
/**
 * Provides the base implementation for the thong ke bao cao remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.ThongKeBaoCaoServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.ThongKeBaoCaoServiceImpl
 * @generated
 */
public abstract class ThongKeBaoCaoServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, ThongKeBaoCaoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ThongKeBaoCaoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ThongKeBaoCaoServiceUtil</code>.
	 */
	 ...
	 */
	public ThongKeBaoCaoService getThongKeBaoCaoService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(thongKeBaoCaoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ThongKeBaoCaoService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ThongKeBaoCaoServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, thongKeBaoCaoService);
		}
	...
	@BeanReference(type = ThongKeBaoCaoService.class)
	protected ThongKeBaoCaoService thongKeBaoCaoService;
