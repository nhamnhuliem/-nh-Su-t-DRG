...
import drg.moh.service.service.DashboardChiPhiBinhQuanService;
import drg.moh.service.service.DashboardChiPhiBinhQuanServiceUtil;
...
/**
 * Provides the base implementation for the dashboard chi phi binh quan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.DashboardChiPhiBinhQuanServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.DashboardChiPhiBinhQuanServiceImpl
 * @generated
 */
public abstract class DashboardChiPhiBinhQuanServiceBaseImpl
	extends BaseServiceImpl
	implements DashboardChiPhiBinhQuanService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DashboardChiPhiBinhQuanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DashboardChiPhiBinhQuanServiceUtil</code>.
	 */
	 ...
	 */
	public DashboardChiPhiBinhQuanService getDashboardChiPhiBinhQuanService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(dashboardChiPhiBinhQuanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DashboardChiPhiBinhQuanService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DashboardChiPhiBinhQuanServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dashboardChiPhiBinhQuanService);
		}
	...
	@BeanReference(type = DashboardChiPhiBinhQuanService.class)
	protected DashboardChiPhiBinhQuanService dashboardChiPhiBinhQuanService;
