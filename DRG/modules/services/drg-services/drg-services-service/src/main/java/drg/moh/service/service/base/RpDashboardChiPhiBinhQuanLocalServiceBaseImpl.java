...
import drg.moh.service.service.RpDashboardChiPhiBinhQuanLocalService;
...
/**
 * Provides the base implementation for the rp dashboard chi phi binh quan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link drg.moh.service.service.impl.RpDashboardChiPhiBinhQuanLocalServiceImpl}.
 * </p>
 *
 * @author SON
 * @see drg.moh.service.service.impl.RpDashboardChiPhiBinhQuanLocalServiceImpl
 * @generated
 */
public abstract class RpDashboardChiPhiBinhQuanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, RpDashboardChiPhiBinhQuanLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RpDashboardChiPhiBinhQuanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RpDashboardChiPhiBinhQuanLocalServiceUtil</code>.
	 */
	...
	@Override
	public RpDashboardChiPhiBinhQuan addRpDashboardChiPhiBinhQuan(
		RpDashboardChiPhiBinhQuan rpDashboardChiPhiBinhQuan) {

		rpDashboardChiPhiBinhQuan.setNew(true);

		return rpDashboardChiPhiBinhQuanPersistence.update(
	...
	public RpDashboardChiPhiBinhQuan createRpDashboardChiPhiBinhQuan(long id) {
		return rpDashboardChiPhiBinhQuanPersistence.create(id);
	}
	...
	@Override
	public RpDashboardChiPhiBinhQuan deleteRpDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return rpDashboardChiPhiBinhQuanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RpDashboardChiPhiBinhQuan deleteRpDashboardChiPhiBinhQuan(
		RpDashboardChiPhiBinhQuan rpDashboardChiPhiBinhQuan) {

		return rpDashboardChiPhiBinhQuanPersistence.remove(
			rpDashboardChiPhiBinhQuan);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return rpDashboardChiPhiBinhQuanPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RpDashboardChiPhiBinhQuan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return rpDashboardChiPhiBinhQuanPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return rpDashboardChiPhiBinhQuanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public RpDashboardChiPhiBinhQuan fetchRpDashboardChiPhiBinhQuan(long id) {
		return rpDashboardChiPhiBinhQuanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RpDashboardChiPhiBinhQuan getRpDashboardChiPhiBinhQuan(long id)
		throws PortalException {

		return rpDashboardChiPhiBinhQuanPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(RpDashboardChiPhiBinhQuan.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			RpDashboardChiPhiBinhQuan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardChiPhiBinhQuanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return rpDashboardChiPhiBinhQuanLocalService.
			deleteRpDashboardChiPhiBinhQuan(
				(RpDashboardChiPhiBinhQuan)persistedModel);
	}

	@Override
	public BasePersistence<RpDashboardChiPhiBinhQuan> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return rpDashboardChiPhiBinhQuanPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RpDashboardChiPhiBinhQuan> getRpDashboardChiPhiBinhQuans(
		int start, int end) {

		return rpDashboardChiPhiBinhQuanPersistence.findAll(start, end);
	}
	...
	public int getRpDashboardChiPhiBinhQuansCount() {
		return rpDashboardChiPhiBinhQuanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RpDashboardChiPhiBinhQuan updateRpDashboardChiPhiBinhQuan(
		RpDashboardChiPhiBinhQuan rpDashboardChiPhiBinhQuan) {
	 ...
	 */
	public RpDashboardChiPhiBinhQuanLocalService
	...
	public void afterPropertiesSet() {
		...
		_setLocalServiceUtilService(rpDashboardChiPhiBinhQuanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RpDashboardChiPhiBinhQuanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				rpDashboardChiPhiBinhQuanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				RpDashboardChiPhiBinhQuanLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, rpDashboardChiPhiBinhQuanLocalService);
		}
	...
	@BeanReference(type = RpDashboardChiPhiBinhQuanLocalService.class)
	protected RpDashboardChiPhiBinhQuanLocalService
		rpDashboardChiPhiBinhQuanLocalService;
